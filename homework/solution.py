...
class Lab01:
    ...
    def main(self):
        ...
        pipeline = self.make_pipeline(LogisticRegression(max_iter=1000,random_state=2024, n_jobs=-1))
    ...
    def make_pipeline(self, estimator):
        transformer = ColumnTransformer(
            transformers=[
                ...
                ('minmax', MinMaxScaler(feature_range=(0,1)), self.columnas_no_categoricas)
            ],
